...
* Used tail and head to view contents of notes.txt
   head -n 1 notes.txt
Adding day 6 tasks to new file
ubuntu@gitserver:~/day6$ tail -1 notes.txt
Appending more tasks to the newfile
ubuntu@gitserver:~/day6$ tail -2 notes.txt
Adding day 6 tasks to new file
Appending more tasks to the newfile
ubuntu@gitserver:~/day6$
